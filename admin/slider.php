		...
		if($validate->validate() && count($stat)==0)

			{
			  ...
			  $aryData=array(	
					...
					$flgIn1 = $db->insertAry("sliders",$aryData);
			...
			if(isset($_FILES["image"]["name"]) && !empty($_FILES["image"]["name"]))
				...
				{	 
				  ...
				  $aryData=array(	
					...
					$flgIn = $db->updateAry("sliders", $aryData , "where id='".$_GET['id']."'");
...
elseif(($_REQUEST['action']=='delete'))

	{
			 	 ...
			 	 $flgIn1 = $db->delete("sliders","where id='".$_GET['id']."'");			
...
<input type="text" class="form-control required" id="userName" name="title" value="<?php echo $_POST['title']; ?>">
                                   ...
                                   <textarea class="form-control required" id="userName" name="description" ><?php echo $_POST['description']; ?></textarea>
                     ...
                     <?php } elseif($_GET['action']=='edit') { 
					    ...
					    $aryDetail=$db->getRow("select * from  sliders where id='".$_GET['id']."'");
		...
		<option value="<?php echo $iLang['id']; ?>" <?php if($aryDetail['language_id']==$iLang['id']) { echo "selected"; } ?>>
			...
			<?php echo $iLang['language']; ?></option>
							...
							<?php } ?>
                                   ...
                                   <textarea class="form-control required" id="userName" name="description" ><?php echo $aryDetail['description']; ?></textarea>
         ...
         <?php  } 
			   ...
			   elseif($_GET['action']=='view') { 
			    ...
			    $GetEmailId=$db->getRow("select * from  sliders where id='".$_GET['id']."'");
                  ...
                  ?>
                         	...
                         	<div class="card-box">
                                  ...
                                  <?php echo $GetEmailId['title']; ?>
										...
										<td><img src="../uploads/<?php echo $GetEmailId['image']; ?>" style="height:50px;"></td>     
					...
					<?php $aryList=$db->getRows("select * from sliders order by id asc");
