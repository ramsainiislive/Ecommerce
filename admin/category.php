...
if(isset($_POST['submit']))
		...
		if($validate->validate() && count($stat)==0)
			...
			$aryChkName=$db->getRow("select pageurl from  categorys where pageurl='$iPageURL'");
 			  ...
 			  $aryData=array(	
					...
					$flgIn1 = $db->insertAry("categorys",$aryData);
  ...
  elseif(isset($_POST['update']))
	...
	$aryChkName=$db->getRow("select pageurl from  categorys where pageurl='$iPageURL' and id!='".$_GET['id']."'");
				if(is_array($aryChkName) && count($aryChkName)>0){   		   
				$stat['error'] = "This PageURL is Already Exist";
				}
				else{
			  ...
			  $aryData=array(	
					...
					$flgIn = $db->updateAry("categorys", $aryData , "where id='".$_GET['id']."'");
...
elseif(($_REQUEST['action']=='delete'))

	{
			 	 ...
			 	 $flgIn1 = $db->delete("categorys","where id='".$_GET['id']."'");			
...
<html>
 ...
 <input type="text" class="form-control required" name="categoryname" value="<?php echo $_POST['categoryname']; ?>">
 ...
 <input type="text" class="form-control required" name="pageurl" value="<?php echo $_POST['pageurl']; ?>">
                     ...
                     <?php } elseif($_GET['action']=='edit') { 
					    ...
					    $aryDetail=$db->getRow("select * from  categorys where id='".$_GET['id']."'");
 ...
 <input type="text" class="form-control required" name="categoryname" value="<?php echo $aryDetail['categoryname']; ?>">
 ...
 <input type="text" class="form-control required" name="pageurl" value="<?php echo $aryDetail['pageurl']; ?>">
         ...
         <?php  } 
					...
					<?php $aryList=$db->getRows("select * from categorys  order by id desc");
