                                        ...
                                        <div>
                                            ...
                                            <section>
                                                <div class="form-group clearfix">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <input type="text" class="form-control required" id="userName" name="current_pass" value="<?php echo $aryDetail['password']; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group clearfix">
                                                    <label class="col-lg-2 control-label " for="userName">New Password *</label>
                                                    <div class="col-lg-10">
                                                        <input type="text" class="form-control required" id="userName" name="new_pass" value="<?php echo $aryDetail['new_pass']; ?>">
                                                    </div>
                                                </div>
												                                                <div class="form-group clearfix">
                                                    <label class="col-lg-2 control-label " for="userName">Confirm Password *</label>
                                                    <div class="col-lg-10">
                                                        <input type="text" class="form-control required" id="userName" name="renew_pass" value="<?php echo $aryDetail['renew_pass']; ?>">
                                                    </div>
                                                </div>
